...
<!--[if gt IE 8]><!--> <html class="no-js" lang="ES"> <!--<![endif]--> 
    <head>
        ...
        <title>Ministerio de Trabajo y Promoción del Empleo</title>
            ...
            <div class="logos-media">
                <div class="container">
                    <div class="col-sm-4 hidden">
                        <img src="img/logo-ministerio.png" class="img-responsive" />
                    </div>

                    <div class="col-sm-4">
                        <a href="#" class="logo-wrapper"><img src="img/logo.png" class="img-responsive" /></a>
                    </div>

                    <div class="col-sm-4 hidden">
                        <ul class="social-media pull-right">
                            <li><a href="#"><img src="img/fb-icon.png" /></a></li>
                            <li><a href="#"><img src="img/tw-icon.png" /></a></li>
                            <li><a href="#"><img src="img/yt-icon.png" /></a></li>
                            <li><a href="#"><img src="img/fk-icon.png" /></a></li>
                            <li><a href="#"><img src="img/sc-icon.png" /></a></li>
                        </ul>
                    </div>
                </div>
            </div>
